...
public:
	...
	void DrawPiramid(float x, float y, float z, float size);
...
private:
	...
	float fY;
	float fZ;
	float fVelocity;	// Velocidade de movimento do teapot,

	float fAngle;	// Ângulo de rotação do teapot
	float fSize;	// Tamanho do teapot
